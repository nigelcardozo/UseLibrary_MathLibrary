package com.nigelcardozo.mathlibrary;

//THIS GITHUB PROJECT RELATES TO THE FOLLOWING BLOG POSTS AT:
...
public class MathX {
    ...
    public int subtractX(int x, int y)
    {
        return (x-y);
    }

    public int multiplyX(int x, int y)
    {
        return (x*y);
    }
